...
/**
 * @title   Nordic Energy Pool Contract 2
 * @author  Nordic Energy
 * @notice  This contract is used for staking Nordic Energy (ERC20) tokens to support a validator running in the PowerChain blockchain network and distribute rewards.
 **/
contract NordicEnergyPool {
    ...
    constructor(IERC20 _litionToken) public {
        owner = msg.sender;
        NordicEnergyToken = _litionToken;
    }
